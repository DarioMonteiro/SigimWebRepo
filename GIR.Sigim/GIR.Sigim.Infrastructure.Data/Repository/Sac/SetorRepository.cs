...
namespace GIR.Sigim.Infrastructure.Data.Repository.Sac
{
    public class SetorRepository : Repository<Setor>, ISetorRepository
    {
        ...
        public SetorRepository(UnitOfWork unitOfWork)
            : base(unitOfWork)
        {
        ...
        public override IEnumerable<Setor> ListarPeloFiltroComPaginacao(
            ISpecification<Setor> specification,
            int pageIndex,
            int pageCount,
            string orderBy,
            bool ascending,
            out int totalRecords,
            params Expression<Func<Setor, object>>[] includes)
        {
