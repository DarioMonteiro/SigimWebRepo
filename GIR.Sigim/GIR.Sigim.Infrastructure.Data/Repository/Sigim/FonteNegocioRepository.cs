...
{
    public class FonteNegocioRepository : Repository<FonteNegocio>, IFonteNegocioRepository
    {
        #region Constructor

        public FonteNegocioRepository(UnitOfWork unitOfWork)
            : base(unitOfWork)
        {
        ...
        public override IEnumerable<FonteNegocio> ListarPeloFiltroComPaginacao(
            ISpecification<FonteNegocio> specification,
            int pageIndex,
            int pageCount,
            string orderBy,
            bool ascending,
            out int totalRecords,
            params Expression<Func<FonteNegocio, object>>[] includes)
        {
