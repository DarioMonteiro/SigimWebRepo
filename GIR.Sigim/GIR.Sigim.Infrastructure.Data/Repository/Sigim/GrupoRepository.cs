...
namespace GIR.Sigim.Infrastructure.Data.Repository.Sigim
{
    public class GrupoRepository : Repository<Grupo>, IGrupoRepository
    {
        ...
        public GrupoRepository(UnitOfWork unitOfWork)
            : base(unitOfWork)
        {
        ...
        public override IEnumerable<Grupo> ListarPeloFiltroComPaginacao(
            ISpecification<Grupo> specification,
            int pageIndex,
            int pageCount,
            string orderBy,
            bool ascending,
            out int totalRecords,
            params Expression<Func<Grupo, object>>[] includes)
        {
