...
{
    public class InteresseBairroRepository : Repository<InteresseBairro>, IInteresseBairroRepository
    {
        #region Constructor

        public InteresseBairroRepository(UnitOfWork unitOfWork)
            : base(unitOfWork)
        {
        ...
        public override IEnumerable<InteresseBairro> ListarPeloFiltroComPaginacao(
            ISpecification<InteresseBairro> specification,
            int pageIndex,
            int pageCount,
            string orderBy,
            bool ascending,
            out int totalRecords,
            params Expression<Func<InteresseBairro, object>>[] includes)
        {
