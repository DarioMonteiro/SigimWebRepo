...
{
    public class RamoAtividadeRepository : Repository<RamoAtividade>, IRamoAtividadeRepository
    {
        #region Constructor

        public RamoAtividadeRepository(UnitOfWork unitOfWork)
            : base(unitOfWork)
        {
        ...
        public override IEnumerable<RamoAtividade> ListarPeloFiltroComPaginacao(
            ISpecification<RamoAtividade> specification,
            int pageIndex,
            int pageCount,
            string orderBy,
            bool ascending,
            out int totalRecords,
            params Expression<Func<RamoAtividade, object>>[] includes)
        {
