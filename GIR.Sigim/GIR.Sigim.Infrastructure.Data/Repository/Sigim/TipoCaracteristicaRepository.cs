...
{
    public class TipoCaracteristicaRepository : Repository<TipoCaracteristica>, ITipoCaracteristicaRepository
    {
        #region Constructor

        public TipoCaracteristicaRepository(UnitOfWork unitOfWork)
            : base(unitOfWork)
        {
        ...
        public override IEnumerable<TipoCaracteristica> ListarPeloFiltroComPaginacao(
            ISpecification<TipoCaracteristica> specification,
            int pageIndex,
            int pageCount,
            string orderBy,
            bool ascending,
            out int totalRecords,
            params Expression<Func<TipoCaracteristica, object>>[] includes)
        {
