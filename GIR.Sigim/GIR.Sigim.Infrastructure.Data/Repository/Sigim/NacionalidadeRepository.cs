...
{
    public class NacionalidadeRepository : Repository<Nacionalidade>, INacionalidadeRepository
    {
        #region Constructor

        public NacionalidadeRepository(UnitOfWork unitOfWork)
            : base(unitOfWork)
        {
        ...
        public override IEnumerable<Nacionalidade> ListarPeloFiltroComPaginacao(
            ISpecification<Nacionalidade> specification,
            int pageIndex,
            int pageCount,
            string orderBy,
            bool ascending,
            out int totalRecords,
            params Expression<Func<Nacionalidade, object>>[] includes)
        {
