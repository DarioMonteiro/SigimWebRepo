...
namespace GIR.Sigim.Infrastructure.Data.Repository.Sigim
{
    public class ProfissaoRepository : Repository<Profissao>, IProfissaoRepository
    {
        ...
        public ProfissaoRepository(UnitOfWork unitOfWork)
            : base(unitOfWork)
        {
        ...
        public override IEnumerable<Profissao> ListarPeloFiltroComPaginacao(
            ISpecification<Profissao> specification,
            int pageIndex,
            int pageCount,
            string orderBy,
            bool ascending,
            out int totalRecords,
            params Expression<Func<Profissao, object>>[] includes)
        {
