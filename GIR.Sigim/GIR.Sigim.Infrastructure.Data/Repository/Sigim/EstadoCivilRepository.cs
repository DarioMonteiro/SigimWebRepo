...
namespace GIR.Sigim.Infrastructure.Data.Repository.Sigim
{
    public class EstadoCivilRepository : Repository<EstadoCivil>, IEstadoCivilRepository
    {
        ...
        public EstadoCivilRepository(UnitOfWork unitOfWork)
            : base(unitOfWork)
        {
        ...
        public override IEnumerable<EstadoCivil> ListarPeloFiltroComPaginacao(
            ISpecification<EstadoCivil> specification,
            int pageIndex,
            int pageCount,
            string orderBy,
            bool ascending,
            out int totalRecords,
            params Expression<Func<EstadoCivil, object>>[] includes)
        {
