...
namespace GIR.Sigim.Infrastructure.Data.Repository.Sigim
{
    public class TipologiaRepository : Repository<Tipologia>, ITipologiaRepository
    {
        ...
        public TipologiaRepository(UnitOfWork unitOfWork)
            : base(unitOfWork)
        {
        ...
        public override IEnumerable<Tipologia> ListarPeloFiltroComPaginacao(
            ISpecification<Tipologia> specification,
            int pageIndex,
            int pageCount,
            string orderBy,
            bool ascending,
            out int totalRecords,
            params Expression<Func<Tipologia, object>>[] includes)
        {
