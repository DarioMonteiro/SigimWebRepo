...
namespace GIR.Sigim.Infrastructure.Data.Repository.Sigim
{
    public class TratamentoRepository : Repository<Tratamento>, ITratamentoRepository
    {
        ...
        public TratamentoRepository(UnitOfWork unitOfWork) 
            : base(unitOfWork)
        {
        ...
        public override IEnumerable<Tratamento> ListarPeloFiltroComPaginacao(
            ISpecification<Tratamento> specification,
            int pageIndex,
            int pageCount,
            string orderBy,
            bool ascending,
            out int totalRecords,
            params Expression<Func<Tratamento, object>>[] includes)
        {
