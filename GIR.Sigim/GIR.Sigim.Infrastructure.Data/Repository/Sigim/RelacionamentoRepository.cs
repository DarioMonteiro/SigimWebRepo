...
{
    public class RelacionamentoRepository : Repository<Relacionamento>, IRelacionamentoRepository
    {
        #region Constructor

        public RelacionamentoRepository(UnitOfWork unitOfWork)
            : base(unitOfWork)
        {
        ...
        public override IEnumerable<Relacionamento> ListarPeloFiltroComPaginacao(
            ISpecification<Relacionamento> specification,
            int pageIndex,
            int pageCount,
            string orderBy,
            bool ascending,
            out int totalRecords,
            params Expression<Func<Relacionamento, object>>[] includes)
        {
