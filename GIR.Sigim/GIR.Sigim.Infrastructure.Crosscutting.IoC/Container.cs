...
namespace GIR.Sigim.Infrastructure.Crosscutting.IoC
{
    public static class Container
    {
        ...
        static void ConfigureContainer()
        {
            ...
            currentContainer.RegisterType<ITaxaAdministracaoRepository, TaxaAdministracaoRepository>();
            #endregion
            ...
            currentContainer.RegisterType<IEntradaMaterialRepository, EntradaMaterialRepository>();
            ...
            currentContainer.RegisterType<ITaxaAdministracaoAppService, TaxaAdministracaoAppService>();
            #endregion
            ...
            #region Ordem de Compra
            currentContainer.RegisterType<IEntradaMaterialAppService, EntradaMaterialAppService>();
