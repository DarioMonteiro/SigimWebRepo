...
namespace GIR.Sigim.Application.Service.Contrato
{
    public interface IContratoAppService : IBaseAppService
    {
        ...
        FileDownloadDTO ExportarMedicao(int contratoId, int? contratadoId, int tipoDocumentoId, string numeroDocumento, DateTime dataEmissao, string valorContratadoItem, FormatoExportacaoArquivo formato);
        ...
        bool AprovarLiberarListaItemLiberacao(int contratoId, List<ItemLiberacaoDTO> listaItemLiberacaoDTO, OperacaoAprovarLiberar operacao);
    }
}
